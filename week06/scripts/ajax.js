function getRandomUser() {
    ...
    xhttp.onreadystatechange = function() {
       if(this.readystate == 4 && this.status == 200) {
           ...
           elAddress.innerHTML = data.results[0].location.street.number + ", " + data.results[0].location.street.name + ", <br>" + data.results[0].location.postcode + " " + " " + data.results[0].location.city + ", <br>" + data.results[0].location.country;
